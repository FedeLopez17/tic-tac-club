DATA = (()=>{
    ...
    const _LEAGUES = {
        ...
        Asia: {
            ...
            // },
            "J1 League": {
                "Avispa Fukuoka": {colors: ["11, 34, 82", "0, 141, 169"], abbreviation: "AVI"},
                "Cerezo Osaka": {colors: ["213, 9, 93", "46, 48, 133"], abbreviation: "CZO"},
                "Consadole Sapporo": {colors: ["255, 0, 0", "0, 0, 0"], abbreviation: "CON"},
                "FC Tokyo": {colors: ["37, 50, 135", "221, 2, 45"], abbreviation: "TKY"},
                "Gamba Osaka": {colors: ["0, 68, 138", "0, 0, 0"], abbreviation: "OSA"},
                "Jubilo Iwata": {colors: ["108, 153, 205", "255, 255, 255"], abbreviation: "JIW"},
                "Kashima Antlers": {colors: ["177, 23, 61", "184, 171, 165"], abbreviation: "KAN"},
                "Kashiwa Reysol": {colors: ["247, 230, 0", "0, 0, 0"], abbreviation: "REY"},
                "Kawasaki Frontale": {colors: ["60, 158, 213", "0, 0, 0"], abbreviation: "KAW"},
                "Kyoto Sanga FC": {colors: ["113, 0, 102"], abbreviation: "KYO"},
                "Nagoya Grampus": {colors: ["205, 17, 22", "235, 141, 0"], abbreviation: "NAG"},
                "Sagan Tosu": {colors: ["0, 152, 198", "228, 82, 148"], abbreviation: "SAG"},
                "Sanfrecce Hiroshima": {colors: ["86, 51, 136"], abbreviation: "SAN"},
                "Shimizu S Pulse": {colors: ["233, 127, 0", "41, 54, 92"], abbreviation: "SHI"},
                "Shonan Bellmare": {colors: ["114, 178, 41", "0, 90, 154"], abbreviation: "SHO"},
                "Urawa Reds": {colors: ["221, 3, 45", "255, 255, 255", "0, 0, 0"], abbreviation: "URA"},
                "Vissel Kobe": {colors: ["108, 26, 46", "255, 255, 255"], abbreviation: "VIS"},
                "Yokohama F Marinos": {colors: ["21, 63, 143", "255, 255, 255", "221, 0, 56"], abbreviation: "YOK"}
            },
            // "K League 1": {
