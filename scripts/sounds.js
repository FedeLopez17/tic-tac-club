const sounds = (()=>{
    ...
    const stadiumAtmosphere = new Audio("./audio/stadium-atmosphere.mp3");
    const refereeWhistle = new Audio("./audio/referee-whistle.mp3");
    ...
    return {selectionOne, selectionTwo, errorOne, coinToss, goal, tie, music, stadiumAtmosphere, refereeWhistle, displaySong};
})();